        ...
        <div className='mt-9 flex w-[90%] mx-auto justify-center'>
          <div className='w-[100%] md:w-[80%]'>
            <form onSubmit={handleSubmit}>
              <h1 className='text-[30px] md:text-[40px] font-bold font-poppins'>Course Registration</h1>
              ...
              <div className='flex flex-col py-2'>
                ...
                <select
                  ...
                  <option value='Digital Forensics & Cyber Security'>Digital Forensics & Cyber Security</option>
              ...
              <div className='flex justify-end py-2'>
                <button type='submit' className='w-[100%] md:w-[200px] text-white bg-black p-3 border  border-black'>
                  Submit
                </button>
              </div>
            </form>
